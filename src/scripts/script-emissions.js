document.addEventListener('DOMContentLoaded', () => {
    ...
    function filterPrograms(category) {
        ...
        // 3. Mise à jour du compteur avec le nouveau format
        // Exemple : "5 émissions retrouvées dans cette catégorie"
        const programLabel = visibleCount > 1 ? 'émissions' : 'émission';
        programCountElement.textContent = `${visibleCount} ${programLabel} retrouvée${visibleCount > 1 ? 's' : ''} dans cette catégorie`;
    }
